...

{
    ...
    QString windowTitle = tr("BinkDogCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BinkDogCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and binkdogcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBINK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BinkDogCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BinkDogCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BinkDogCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BinkDogCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BinkDogCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BinkDogCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BinkDogCoin Core help message to get a list with possible BinkDogCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BinkDogCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BinkDogCoin network", "", count));
}
...
{
    QString strTitle = tr("BinkDogCoin Core"); // default title
