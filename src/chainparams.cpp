...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 500; // (BinkDogCoin: 259200)
        //if the lowest block height (vSortedByTimestamp[0]) is >= switch height, use new modifier calc
        // nModifierUpdateBlock = 0; // (BinkDogCoin: 615800)
        nZerocoinStartHeight = 90000; // (BinkDogCoin: 863787, Phore 90000)
        ...
        nBlockRecalculateAccumulators = 90005; // (BinkDogCoin: 895400, Phore 90005) //Trigger a recalculation of accumulators
        // nBlockFirstFraudulent = 90002; // (BinkDogCoin: 908000, Phore 90002) //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 90005; // (BinkDogCoin: 891730, Phore 90005) //Last valid accumulator checkpoint
        // nBlockEnforceInvalidUTXO = 0; // (BinkDogCoin: 902850) //Start enforcing the invalid UTXO's
        // nInvalidAmountFiltered = 268200*COIN; // (BinkDogCoin: 268200) //Amount of invalid coins filtered through exchanges, that should be considered valid
        nBlockZerocoinV2 = 99999; // (BinkDogCoin: 1153160) //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        nEnforceNewSporkKey = 1525158000; // (BinkDogCoin: 1525158000) //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1527811200; // (BinkDogCoin: 1527811200) //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        // BinkDogCoin addresses start with 'S'
...
public:
    CTestNetParams()
    {
        ...
        // Testnet BinkDogCoin addresses start with 'm' or 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,111);
        // Testnet BinkDogCoin script addresses start with '2'
