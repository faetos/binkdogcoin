...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BinkDogCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BinkDogCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"binkdogcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"binkdogcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"binkdogcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"binkdogcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"binkdogcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"binkdogcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"binkdogcoin", "startmasternode", &startmasternode, true, true, false},
        {"binkdogcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"binkdogcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"binkdogcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"binkdogcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"binkdogcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"binkdogcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"binkdogcoin", "mnbudget", &mnbudget, true, true, false},
        {"binkdogcoin", "preparebudget", &preparebudget, true, true, false},
        {"binkdogcoin", "submitbudget", &submitbudget, true, true, false},
        {"binkdogcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"binkdogcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"binkdogcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"binkdogcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"binkdogcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"binkdogcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"binkdogcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"binkdogcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"binkdogcoin", "mnsync", &mnsync, true, true, false},
        {"binkdogcoin", "spork", &spork, true, true, false},
        {"binkdogcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> binkdogcoin-cli " + methodname + " " + args + "\n";
}
