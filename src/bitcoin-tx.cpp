...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BinkDogCoin Core binkdogcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  binkdogcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded binkdogcoin transaction") + "\n" +
                               "  binkdogcoin-tx [options] -create [commands]   " + _("Create hex-encoded binkdogcoin transaction") + "\n" +
                               "\n";
