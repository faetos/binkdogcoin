...
This mechanism has been integrated into Bitcore-Node-BinkDogCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BinkDogCoin-Project/insight-api-binkdogcoin#web-socket-api](https://github.com/BinkDogCoin-Project/insight-api-binkdogcoin#web-socket-api) 
* API: [https://github.com/BinkDogCoin-Project/insight-api-binkdogcoin#swifttx-transactions](https://github.com/BinkDogCoin-Project/insight-api-binkdogcoin#swifttx-transactions) 
...
By default, the BinkDogCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BinkDogCoin Core daemon:
