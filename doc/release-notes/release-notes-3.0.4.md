...
- #314 `f1c830a` Fix issue causing crash when binkdogcoind --help was invoked (Jon Spock)
- #326 `8b6a13e` Combine 2 LogPrintf statement to reduce debug.log clutter (Jon Spock)
- #328 `a6c18c8` [Main] BinkDogCoin not responding on user quitting app (Aaron Langford)
