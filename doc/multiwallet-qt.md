...
In order to support loading of multiple wallets in binkdogcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is binkdogcoin.cpp.
...
Changes to binkdogcoin.cpp
----------------------
binkdogcoin.cpp is the entry point into binkdogcoin-qt, and as such, will require some minor modifications to provide hooks for
