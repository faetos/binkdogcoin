...
!else
InstallDir $PROGRAMFILES\BinkDogCoin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "BinkDogCoin Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\binkdogcoin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\BinkDogCoin Core (testnet, -bit).lnk" "$INSTDIR\binkdogcoin-qt" "-testnet" "$INSTDIR\binkdogcoin-qt" 1
    ...
    WriteRegStr HKCR "binkdogcoin" "URL Protocol" ""
    WriteRegStr HKCR "binkdogcoin" "" "URL:BinkDogCoin"
    WriteRegStr HKCR "binkdogcoin\DefaultIcon" "" $INSTDIR\binkdogcoin-qt
    WriteRegStr HKCR "binkdogcoin\shell\open\command" "" '"$INSTDIR\binkdogcoin-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\binkdogcoin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\BinkDogCoin Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\BinkDogCoin.lnk"
