Contributing to BinkDogCoin Core
============================

The BinkDogCoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to binkdogcoin-qt
...
The following applies to code changes to the BinkDogCoin Core project, and is not to be
confused with overall BinkDogCoin Network Protocol consensus changes.

Whether a pull request is merged into BinkDogCoin Core rests with the project merge
...
Patches that change BinkDogCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BinkDogCoin consensus, it must have been
...
The project leader is the release manager for each BinkDogCoin Core release.
